...
int main(void)
{
        ...
        //If server cannot handle the client, the client would get connected but after server sends the message that "Server Full", server disconnects the client
        //Server has to connect once, because message can't be sent without connection
        printf("\nConnected to server.\n");
