...
insert into Loans values(2, '0987654321234', 'Asad', GETDATE(), DATEADD(day, 7, GETDATE())),
(1,'9089786756453','Asad', GETDATE(), DATEADD(day, 7, GETDATE())),
(1,'1213141516171', 'Siddiq', GETDATE(), DATEADD(day, 7, GETDATE()));
