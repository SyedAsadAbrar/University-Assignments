<%@ Page Title="" Language="C#" MasterPageFile="~/adminLayout.Master" AutoEventWireup="true" CodeBehind="AddConcert.aspx.cs" Inherits="DatabaseProject.AddConcert" %>
    ...
    <div class="container">
        <div class="row">
            <div class="center_div text">
                ...
                <br />
                <p>Date</p>
                <asp:Calendar ID="CDate" runat="server" onkeypress="valueInsert(this)"></asp:Calendar>
                <br />

                <p>Performer</p>
                <asp:TextBox ID="performer" CssClass=" form-control" runat="server" onkeypress=" valueInsert(this)"></asp:TextBox>
                <br />
                <p>Organizers</p>
                ...
                <br />
                <p>Cost</p>
                <asp:TextBox ID="CCost" CssClass="form-control" type="number" min="1" runat="server" onkeypress=" valueInsert(this)"></asp:TextBox>
                <br />
                <p>Concert Poster</p>
                ...
                <br />
                <asp:Button ID="AddImage" CssClass="btn btn-warning btn-block btn-lg" runat="server" Text="Submit" OnClick="AddConcert_Click" />
                <br />
